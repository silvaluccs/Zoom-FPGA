	module unidade_de_controle(
		...
		reg [16:0] endereco_memoria;
		
		reg [16:0] endereco_escrita;
		reg permicao_escrita;
		
		reg escrita_dados;
		
		reg botao_zoom_in_reg;
		reg botao_zoom_out_reg;
		reg seletor_algoritmo_reg;
		...
		reg pixel_para_salvar;
		reg [31:0] pixels_processados_reg;

		reg [1:0] salvar_pixels;
