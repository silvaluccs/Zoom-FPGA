...
/* Delays em microsegundos - ajuste conforme necessário */
#define DELAY_CURTO     3      /* 0.1ms */
#define DELAY_MEDIO     1562    /* 50ms */
#define DELAY_LONGO     3125   /* 100ms */
