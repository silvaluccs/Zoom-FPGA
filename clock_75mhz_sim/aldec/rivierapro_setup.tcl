...
# ACDS 23.1 991 linux 2025.09.25.20:56:42
# ----------------------------------------
...
# ----------------------------------------
# If clock_75mhz is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clock_75mhz"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/lucas/intelFPGA_lite/23.1std/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clock_75mhz.vo"
}
